...
Este projeto tem como objetivo servir como um ambiente seguro para profissionais da fotografia, para compartilharem seus portifolios e conseguirem manter um local de conversa fluido com seus possiveis clientes.  **MVC (Model-View-Controller)** utilizando
